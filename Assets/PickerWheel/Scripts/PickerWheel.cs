   ...
   public class PickerWheel : MonoBehaviour {
      ...
      private void DrawPiece (int index)
      {
        ...
        pieceTrns.RotateAround (wheelPiecesParent.position, Vector3.back, pieceAngle * index) ;
            ...
            //pieceTrns.GetComponent<RectTransform>().anchoredPosition = pieceTrns.parent.GetComponent<RectTransform>().anchoredPosition;
            //pieceTrns.GetChild(0).GetComponent<RectTransform>().anchoredPosition = pieceTrns.parent.GetComponent<RectTransform>().anchoredPosition;
            //pieceTrns.GetChild(1).GetComponent<RectTransform>().anchoredPosition = pieceTrns.parent.GetComponent<RectTransform>().anchoredPosition;
            //pieceTrns.GetChild(2).GetComponent<RectTransform>().anchoredPosition = pieceTrns.parent.GetComponent<RectTransform>().anchoredPosition;
        }
